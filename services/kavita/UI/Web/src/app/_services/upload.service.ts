...
export class UploadService {
  ...
  updateSeriesCoverImage(seriesId: number, url: string, lockCover: boolean = true) {
    return this.httpClient.post<number>(this.baseUrl + 'upload/series', {
      id: seriesId,
      url: this._cleanBase64Url(url),
      lockCover
    }).pipe(tap(_ => {
  ...
  updateCollectionCoverImage(tagId: number, url: string, lockCover: boolean = true) {
    return this.httpClient.post<number>(this.baseUrl + 'upload/collection', {
      id: tagId,
      url: this._cleanBase64Url(url),
      lockCover
    }).pipe(tap(_ => {
  ...
  updateReadingListCoverImage(readingListId: number, url: string, lockCover: boolean = true) {
    return this.httpClient.post<number>(this.baseUrl + 'upload/reading-list', {
      id: readingListId,
      url: this._cleanBase64Url(url),
      lockCover
    }).pipe(tap(_ => {
  ...
  updateChapterCoverImage(chapterId: number, url: string, lockCover: boolean = true) {
    return this.httpClient.post<number>(this.baseUrl + 'upload/chapter', {
      id: chapterId,
      url: this._cleanBase64Url(url),
      lockCover
    }).pipe(tap(_ => {
  ...
  updateVolumeCoverImage(volumeId: number, url: string, lockCover: boolean = true) {
    return this.httpClient.post<number>(this.baseUrl + 'upload/volume', {
      id: volumeId,
      url: this._cleanBase64Url(url),
      lockCover
    }).pipe(tap(_ => {
  ...
  updateLibraryCoverImage(libraryId: number, url: string, lockCover: boolean = true) {
    return this.httpClient.post<number>(this.baseUrl + 'upload/library', {
      id: libraryId,
      url: this._cleanBase64Url(url),
      lockCover
    }).pipe(tap(_ => {
  ...
  updatePersonCoverImage(personId: number, url: string, lockCover: boolean = true) {
    return this.httpClient.post<number>(this.baseUrl + 'upload/person', {
      id: personId,
      url: this._cleanBase64Url(url),
      lockCover
    }).pipe(tap(_ => {
  ...
  updateUserCoverImage(userId: number, url: string) {
    return this.httpClient.post<number>(this.baseUrl + 'upload/user', {
      id: userId,
      url: this._cleanBase64Url(url),
      lockCover: false
    }).pipe(tap(_ => {
