  ...
  transform(result: CblBookResult): string {
    switch (result.reason) {
      ...
      case CblImportReason.ChapterMissing:
        return failIcon + this.translocoService.translate('cbl-conflict-reason-pipe.chapter-missing', {
      ...
      case CblImportReason.VolumeMissing:
        return failIcon + this.translocoService.translate('cbl-conflict-reason-pipe.volume-missing', {
          series: result.series,
