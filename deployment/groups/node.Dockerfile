# ✅ node.Dockerfile — Build All Node.js Noona Services
...
# 🔚 Final Notes
# ─────────────────────────────────────────────
# All services are built with noona-builder.
# Use with:
# docker build --target noona-portal -f deployment/groups/node.Dockerfile .
